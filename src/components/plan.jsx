        ...
        >
            <div className="flex items-center gap-4 w-full flex-col sm:flex-row">
                ...
                <div className="flex justify-center gap-8 bg-[#f0f6ff] p-2 rounded-m w-full">
                    ...
                    <div 
                        onClick={changeMode} 
                        className={`flex ${click ? 'justify-end' : 'justify-start'} items-center p-1 bg-[#02295a] h-[25px] w-[50px] rounded-2xl cursor-pointer`}
                    >
                        <div className="rounded-full bg-[white] h-[15px] w-[15px]"></div>
                    </div>
                    <h1>Yearly</h1>
                </div>
        </Structure>
...
function Card({plan, active, setActive, price, mode, children}){
    ...
    return (
        <div 
            ...
            className={`flex sm:flex-col gap-3 h-fit w-full hover:border-[#473dff] hover:bg-[#fafbff] border-[1px] p-3 
        ...
        >
            ...
            <div>
                ...
                { mode && <p className="text-[#02295a] font-semibold text-xs">2 months free</p> }
            </div>
        </div>
    )
}