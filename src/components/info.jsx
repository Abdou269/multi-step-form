...
export default function Info({ formRef }){
    ...
    return (
        <form ref={formRef} onSubmit={
            ...
            className="flex flex-col justify-between gap-6 sm:h-[90%] sm:w-[90%] bg-white rounded-xl sm:p-0 p-8 h-fit w-[90%] max-[640px]:absolute max-[640px]:top-[50%] max-[640px]:translate-y-[-50%]"
        >
