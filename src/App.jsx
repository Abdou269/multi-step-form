...
export default function App(){
    ...
    return (
        <context.Provider value={[step, setStep, dataDispatch, newData, data.addons]}>
            <div className='flex justify-center items-center h-full w-full sm:p-2 sm:px-4 p-0 flex-col sm:flex-row'>
                <div className={`flex justify-center sm:h-[90%] h-[25%] sm:w-[250px] text-nowrap p-6 text-white sm:rounded-xl w-full 
                ...
                <div className='flex items-center justify-center flex-col w-full h-[90%]'>
                    <div className='flex flex-col items-center justify-center h-full w-full'>
                        <div className='flex justify-center items-center h-full w-full'>
                            <div className='flex flex-col justify-center items-center sm:w-11/12 h-full w-[90%]'>
                    ...
                    </div>
                    {
                        step < 5 && 
                        (
                            <div className="flex items-center justify-between sm:w-[80%] gap-2 p-4 bg-white w-full">
                                ...
                                <button 
                                    ...
                                    className='text-white p-2 px-5 rounded-[8px] bg-[#02295a] hover:bg-[#011f45]'
                                >
